...
const ComplaintCard = React.memo(
  ({ complaint, expanded, onToggleExpand }) => {
    ...
    return (
      <div className={`complaint-card ${expanded ? "expanded" : ""}`}>
            ...
            >
              <div className="complaint-details">
                ...
                {complaint.engineerMessage && (
                  <div className="detail-row full-width">
                    <span className="detail-label">Engineer Response:</span>
              ...
              <div className="form-grid">
                ...
                <div className="form-section span-2">
                  ...
                  <div className="section-grid">
                    ...
                    <div className="form-field">
                      <label htmlFor="Complaint Sub-Type">Complaint Sub-Type</label>
                      <div className="select-with-clear">
                        <select
                          id="Complaint Sub-Type"
